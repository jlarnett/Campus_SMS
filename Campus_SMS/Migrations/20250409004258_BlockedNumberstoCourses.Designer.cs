...
namespace Campus_SMS.Migrations
{
    ...
    [Migration("20250409004258_BlockedNumberstoCourses")]
    partial class BlockedNumberstoCourses
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Campus_SMS.Entities.ClassCourse", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("BlockedNumbers")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Campus_SMS.Entities.OpenAIUploadedDocs", b =>
                {
                    ...
                    b.Property<string>("CourseFolder")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
